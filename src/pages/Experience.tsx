...
const roles = [
  ...
  },
  {
    ...
    role: "Director",
    description:
      "Serving as a director within a diversified organisation committed to investing in job-creating and impact-oriented sectors of the Nigerian economy, with operating interests spanning hospitality, education, real estate, and agriculture. The Group operates with a long-term thesis centred on economic development and social value creation, deploying capital and operational capacity into sectors that drive employment, skills development, and community resilience.",
  },
];
